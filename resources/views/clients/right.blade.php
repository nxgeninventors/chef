...
<!-- drawer component -->
<div id="drawer-right-example" class="fixed z-40 h-screen p-4 overflow-y-auto bg-white  dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-right-label">
    ...
    @include('components.clients.add')
</div>